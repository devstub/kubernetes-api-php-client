...
class ReplicationControllerArray  extends EntityArray {
     ...
     *
     * @param \Binarygoo\KubernetesAPIClient\Entity\v1beta1\ReplicationController|NULL $value
     *
     ...
     * @param mixed $index
     * @param \Binarygoo\KubernetesAPIClient\Entity\v1beta1\ReplicationController $value
     *
     * @return \Binarygoo\KubernetesAPIClient\Entity\v1beta1\ReplicationController
     */
