...
class ReplicationControllerArray  extends EntityArray  implements \JsonSerializable {
     ...
     *
     * @param \DevStub\KubernetesAPIClient\Entity\v1beta1\ReplicationController|NULL $value
     *
     * @return \DevStub\KubernetesAPIClient\Entity\v1beta1\ReplicationController
     */
     ...
     * @param mixed $index
     * @param \DevStub\KubernetesAPIClient\Entity\v1beta1\ReplicationController $value
     *
     * @return \DevStub\KubernetesAPIClient\Entity\v1beta1\ReplicationController
     */
