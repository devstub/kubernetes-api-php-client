...
class ContainerManifestArray extends EntityArray  implements \JsonSerializable {

    /**
     * Appends the value at the end of the array
     *
     * @param \Binarygoo\KubernetesAPIClient\Entity\v1beta1\ContainerManifest|NULL $value
     *
     ...
     * @param mixed $index
     * @param \Binarygoo\KubernetesAPIClient\Entity\v1beta1\ContainerManifest $value
     *
     * @return \Binarygoo\KubernetesAPIClient\Entity\v1beta1\ContainerManifest
     */
