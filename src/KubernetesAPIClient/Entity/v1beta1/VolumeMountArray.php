...
class VolumeMountArray extends EntityArray  implements \JsonSerializable {

    /**
     * Appends the value at the end of the array
     *
     * @param \DevStub\KubernetesAPIClient\Entity\v1beta1\VolumeMount|NULL $value
     *
     * @return \DevStub\KubernetesAPIClient\Entity\v1beta1\VolumeMount
     */
    public function append($value = self::UNIQUE_DEFAULT) {
        if ($value === self::UNIQUE_DEFAULT) {
            $value = new VolumeMount();
     ...
     * @param mixed $index
     * @param \DevStub\KubernetesAPIClient\Entity\v1beta1\VolumeMount $value
     *
     * @return \DevStub\KubernetesAPIClient\Entity\v1beta1\VolumeMount
     */
